...
//    readTimer.start();
    ...
    //std::cout << "Elapsed time: " << readTimeS << " seconds. Data read: " << readSizeMB << " MB. " << " data rate: " << MB_per_s << " MB/s\n";
...
int RHXController::findConnectedChips(std::vector<ChipType> &chipType, std::vector<int> &portIndex, std::vector<int> &commandStream,
                                      std::vector<int> &numChannelsOnPort, bool /* synthMaxChannels */)
{
...
//    std::cout << "digOutVoltageLevel: " << digOutVoltageLevel << '\n';
    std::cout << "NUM SPI PORTS: " << numPorts << "\n";
